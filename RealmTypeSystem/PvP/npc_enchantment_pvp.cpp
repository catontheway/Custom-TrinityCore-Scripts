...
static void Enchant(Player* player, Item* item, uint32 enchantid)
{
	if (!item)
	{
...
static void RemoveEnchant(Player* player, Item* item)
{
	if (!item)
	{
...
class npc_enchantment_pvp : public CreatureScript
{
public:
	npc_enchantment_pvp() : CreatureScript("npc_enchantment_pvp") { }
...
void AddSC_npc_enchantment_pvp()
{
	new npc_enchantment_pvp();
}