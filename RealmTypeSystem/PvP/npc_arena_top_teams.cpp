...
class npc_arena_top_teams : public CreatureScript
{
private:
...
public:
	npc_arena_top_teams() : CreatureScript("npc_arena_top_teams"){}
	...
	bool OnGossipSelect(Player* player, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
	{
		...
		case ARENA_HELP:
		{
			ChatHandler(player->GetSession()).PSendSysMessage("|cffff6060[Information]:|r This npc show the top pvpers (Top 3).Simple click on team name and see the details");
			break;
		}
		case ARENA_2V2_LADDER:
		case ARENA_5V5_LADDER:
		case ARENA_3V3_LADDER:
		{
			...
			else
			{
				...
				player->ADD_GOSSIP_ITEM(0, "Top Arena List:", GOSSIP_SENDER_MAIN, ARENA_GOODBYE);
				do
				{
...
void AddSC_npc_arena_top_teams()
{
	new npc_arena_top_teams();
}